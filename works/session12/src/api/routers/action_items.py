...
from ..schemas import ActionItemCreate, ActionItemRead, ActionItemListResponse
...
def list_action_items_route(
    meeting_id: str,
    owner: Optional[str] = None,
    limit: int = Query(default=20, ge=1, le=100),
    offset: int = Query(default=0, ge=0),
):
    total, items = list_action_items(meeting_id, owner=owner, limit=limit, offset=offset)
